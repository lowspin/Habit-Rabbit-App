...
public class MainActivity extends AppCompatActivity {
    ...
    Tracker mTracker;
    String screenName = "MainActivityFree";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // FAB - remove for free version because design clash with banner ad
...
//        });
    ...
    private void editProject() {
        ...
        if (projects.size()>0) {
            ...
            Snackbar.make(findViewById(R.id.adView), R.string.main_project_add_project_message, Snackbar.LENGTH_LONG)
